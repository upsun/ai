...
**PHP Version**: Sylius requires PHP 8.1 or higher. Use the latest stable PHP version from the registry.
...
- Service type: `mariadb:11.8` or `mysql:<choose supported version>`

**PostgreSQL Alternative**:
- Change service type to `postgresql:<choose supported version>`
...
Note: Image and service versions in this file were selected from the Upsun registry snapshot. Always verify and, if needed, update versions against the canonical registry before committing: https://meta.upsun.com/images
