...
**PHP Version**: Sylius requires PHP 8.1 or higher. Use the latest stable PHP version from the registry (here: php:8.4).
...
- Service type: `mariadb:11.4` or `mysql:<compatible-version>`
