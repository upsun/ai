...
**PHP Version**: Sylius requires PHP 8.1 or higher. Use the latest stable PHP version from the registry (example uses php:8.4).
...
- Service type: `mariadb:11.4` or `mysql:8.1`
...
- `var/cache`: Symfony cache files (could use instance source for better performance)
