...
Note: This reference uses runtime and service versions from the provided registry snapshot (nodejs:24, postgresql:18). Always verify versions against the canonical registry before committing: https://meta.upsun.com/images
