...
**Configuration Notes**:
- **Runtime Version**: Choose appropriate Go version from Registry (example uses golang:1.26)
...
Note: Versions in this file were selected from the Upsun image registry snapshot. Always verify runtime and service versions against the canonical registry before committing: https://meta.upsun.com/images
