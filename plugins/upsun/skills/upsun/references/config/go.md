...
**Configuration Notes**:
- **Runtime Version**: Choose appropriate Go version from Registry
...
Note: Always verify image and service versions against the canonical Upsun registry before committing, as versions are deprecated or retired over time: https://meta.upsun.com/images
