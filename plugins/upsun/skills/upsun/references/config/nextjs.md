...
Note: This reference uses the Node.js runtime image `nodejs:24` as a supported version from the Upsun image registry. Always verify image versions against the canonical registry before committing: https://meta.upsun.com/images
