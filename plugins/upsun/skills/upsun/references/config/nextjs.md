...
Note: This reference uses the Upsun runtime image nodejs:24 (a supported image in the registry snapshot). Always verify image and service versions against the canonical registry before committing: https://meta.upsun.com/images
