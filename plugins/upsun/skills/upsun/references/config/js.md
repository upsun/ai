...
- **bun** and **npx**: Available on Node.js 20+ (note: Node.js 20 is deprecated in registry; prefer Node.js 24)
...
Note: Always verify runtime and service versions against the canonical registry before committing: https://meta.upsun.com/images. The registry snapshot used in this reference selects nodejs:24 (supported).
