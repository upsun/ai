...
Note: Verify runtime and service versions against the canonical registry before committing: https://meta.upsun.com/images. Examples in this file use python:3.14 and postgresql:18 (supported versions at time of writing).
