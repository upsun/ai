...
applications:
  site:
    # If your app lives in a subdirectory of the repository, set source.root accordingly (omit this whole block when the app is at repository root).
    # source:
    #   root: /path/to/app
...
Note: Selected images in this reference: python:3.14 and postgresql:18. Always verify available versions at the canonical registry before committing: https://meta.upsun.com/images
