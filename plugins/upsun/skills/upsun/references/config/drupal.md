...
**Template Usage**: Customize configuration for your Drupal project as needed. Exclude explanatory comments from production YAML.
...
- Use latest stable Registry version: mariadb:11.4
