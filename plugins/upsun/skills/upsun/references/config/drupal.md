...
- **PHP Version**: Use PHP 8.5 for Drupal 11, or 8.4+ for Drupal 10
...
- Use latest stable version in the Registry (11.8)
...
Note: Verify the exact runtime and service versions against the canonical registry before committing: https://meta.upsun.com/images
