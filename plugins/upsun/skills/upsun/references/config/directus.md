...
**Security Notes**:
- Admin credentials come from `ADMIN_EMAIL` and `ADMIN_PASSWORD` Upsun variables; bootstrap may fail if either is missing. Mark `ADMIN_PASSWORD` as sensitive when creating it.
