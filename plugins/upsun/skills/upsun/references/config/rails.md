...
Note: this reference pins Upsun images to registry versions shown above. Always verify image versions against the canonical registry before committing: https://meta.upsun.com/images
